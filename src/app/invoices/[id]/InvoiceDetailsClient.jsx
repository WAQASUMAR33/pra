...
export default function InvoiceDetailsClient({ id }) {
  ...
  if (id === 'placeholder') {
    return (
      <div className="content-body" style={{ textAlign: 'center', padding: '3rem 1rem' }}>
        <h2>Dynamic Route Template</h2>
        <p style={{ color: 'var(--text-muted)' }}>This page is used as a static template for dynamic runtime invoicing routes.</p>
      </div>
    );
  }
